      ...
      <ExtendableBlockItems className="accordion-wrapper">
        <ExtendableBlockItem>
          <ExtendableBlockListAccordionItem>
            ...
            <ExtendableBlockList className="nav-mob-accordion__content">
              ...
              <ExtendableBlockListItem>
                <Link passHref href={createLink.forCollection('the-jewelry-store')}>
                  <a>Jewelry</a>
                </Link>
              </ExtendableBlockListItem>
              <ExtendableBlockListItem>
                <Link passHref href={createLink.forCollection('gift-sets')}>
                  <a>Gift Sets</a>
                </Link>
              </ExtendableBlockListItem>
              <ExtendableBlockListItem>
        ...
        <ExtendableBlockItem>
          <ExtendableBlockListAccordionItem>
            ...
            <ExtendableBlockList className="nav-mob-accordion__content">
              <ExtendableBlockListItem>
                <Link passHref href={createLink.forCollection('all-products', null, 'fragrance=Fragrance:%20Aquatic')}>
                  <a>Aquatic</a>
                </Link>
              </ExtendableBlockListItem>
              <ExtendableBlockListItem>
                <Link passHref href={createLink.forCollection('all-products', null, 'fragrance=Fragrance:%20Citrus')}>
                  <a>Citrus</a>
                </Link>
              </ExtendableBlockListItem>
              <ExtendableBlockListItem>
                <Link passHref href={createLink.forCollection('all-products', null, 'fragrance=Fragrance:%20Floral')}>
                  <a>Floral</a>
                </Link>
              </ExtendableBlockListItem>
              <ExtendableBlockListItem>
                <Link
                  passHref
                  href={createLink.forCollection('all-products', null, 'fragrance=Fragrance:%20Floral%20Woods')}
                >
                  <a>Floral Wood </a>
                </Link>
              </ExtendableBlockListItem>
              <ExtendableBlockListItem>
                <Link passHref href={createLink.forCollection('all-products', null, 'fragrance=Fragrance:%20Fresh')}>
                  <a>Fresh</a>
                </Link>
              </ExtendableBlockListItem>
              <ExtendableBlockListItem>
                <Link passHref href={createLink.forCollection('all-products', null, 'fragrance=Fragrance:%20Fruity')}>
                  <a>Fruity</a>
                </Link>
              </ExtendableBlockListItem>
              <ExtendableBlockListItem>
                <Link passHref href={createLink.forCollection('all-products', null, 'fragrance=Fragrance:%20Gourmand')}>
                  <a>Gourmand</a>
                </Link>
              </ExtendableBlockListItem>
              <ExtendableBlockListItem>
                <Link passHref href={createLink.forCollection('all-products', null, 'fragrance=Fragrance:%20Green')}>
                  <a>Green</a>
                </Link>
              </ExtendableBlockListItem>
              <ExtendableBlockListItem>
                <Link passHref href={createLink.forCollection('all-products', null, 'fragrance=Fragrance:%20Musky')}>
                  <a>Musky</a>
                </Link>
              </ExtendableBlockListItem>
              <ExtendableBlockListItem>
                <Link
                  passHref
                  href={createLink.forCollection('all-products', null, 'fragrance=Fragrance:%20Spicy/%20Smoky')}
                >
                  <a>Spicy/ Smoky</a>
                </Link>
              </ExtendableBlockListItem>
        ...
        <ExtendableBlockItem>
            ...
            <ExtendableBlockListAccordionItem>
              ...
              <ExtendableBlockList className="nav-mob-accordion__content">
                <ExtendableBlockListItem>
                  <Link
                    passHref
                    href={createLink.forCollection('all-products', null, 'material=Material:%2018K%20Gold%20Plated')}
                  >
                    <a>18K Gold Plated</a>
                  </Link>
                </ExtendableBlockListItem>
                <ExtendableBlockListItem>
                  ...
                  >
                    <a>925 Sterling Silver</a>
                  </Link>
                </ExtendableBlockListItem>
                <ExtendableBlockListItem>
                  <Link
                    passHref
                    href={createLink.forCollection('all-products', null, 'material=Material:%20Rhodium%20plated')}
                  >
                    <a>Rhodium plated</a>
                  </Link>
                </ExtendableBlockListItem>
          ...
          <div>
            <ExtendableBlockListAccordionItem>
              ...
              <ExtendableBlockList className="nav-mob-accordion__content">
                <ExtendableBlockListItem>
                  <Link passHref href={createLink.forCollection('all-products', null, 'color=Metal%20Color:%20Black')}>
                    <a>Black</a>
                  </Link>
                </ExtendableBlockListItem>
                <ExtendableBlockListItem>
                  <Link passHref href={createLink.forCollection('all-products', null, 'color=Metal%20Color:%20Gold')}>
                    <a>Gold</a>
                  </Link>
                </ExtendableBlockListItem>
                <ExtendableBlockListItem>
                  <Link
                    passHref
                    href={createLink.forCollection('all-products', null, 'color=Metal%20Color:%20Rose%20Gold')}
                  >
                    <a>Rose Gold</a>
                  </Link>
                </ExtendableBlockListItem>
                <ExtendableBlockListItem>
                  <Link passHref href={createLink.forCollection('all-products', null, 'color=Metal%20Color:%20Silver')}>
                    <a>Silver</a>
                  </Link>
                </ExtendableBlockListItem>
                <ExtendableBlockListItem>
  ...
  <ExtendableBlock>
    <ExtendableBlockContainer>
      ...
      <ExtendableBlockItem>
        ...
        <ExtendableBlockList>
          <ExtendableBlockListItem>
            <Link passHref href={createLink.forPage('inner-circle', null, 'how-it-works')}>
              <a>How it works</a>
            </Link>
          </ExtendableBlockListItem>
          <ExtendableBlockListItem>
            <Link passHref href={createLink.forPage('inner-circle', null, 'join-now')}>
              <a>Join now</a>
            </Link>
          </ExtendableBlockListItem>
          <ExtendableBlockListItem>
            <Link passHref href={createLink.forPage('inner-circle', null, 'current-box')}>
              <a>Current box</a>
            </Link>
          </ExtendableBlockListItem>
          <ExtendableBlockListItem>
            <Link passHref href={createLink.forCollection('esic')}>
              <a>Members Only Store</a>
            </Link>
          </ExtendableBlockListItem>
          <ExtendableBlockListItem>
            <Link passHref href={createLink.forPage('rare-ic-page')}>
              <a>Rare Collections</a>
            </Link>
          </ExtendableBlockListItem>
        </ExtendableBlockList>
      </ExtendableBlockItem>
