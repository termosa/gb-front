...
import { loadProduct } from '@fragrantjewels/gravity-brands.modules.load-product/loadProduct'
import { parse } from 'node-html-parser'
import { formatText } from '../../gravity-brands/modules/format-text'
...
const Product = (): React.ReactElement | null => {
  ...
  useEffect(() => {
    if (productId) {
      loadProduct(Number(productId)).then((product) => {
        setProduct(product)
        setActualPrice(product.variants[0].actual_price)
