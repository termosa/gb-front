      ...
      <div className="app-re-wrapper" id="app-wrapper">
                ...
                <div className="app-row">
                  <div className="app-col">
                    <div className="app-re-header-nav-wrapper">
                      <span id="app-hamburger" className="app-hamburger" />
                    ...
                    <div className="app-row">
                      <div className="app-col app-customer-info-col">
                        <div className="app-re-header__customer-info">
                          <a className="app-auth-link app-auth-link__login" href="/account/login">
                            Log In
                          </a>
                          &nbsp;/&nbsp;
                          <a className="app-auth-link app-auth-link__login" href="/account/register">
                            Sign Up
                          </a>
                        </div>
                      </div>
                      ...
                      <div className="app-col app-re-header__icon-nav">
                        <button
                          type="button"
                          className="app-re-header__icon-nav__search"
                        ...
                        <a
                          href="/account/login"
                          className="app-re-header__icon-nav__customer"
                          ...
                          <div className="app-user__dropdown">
                            <div className="app-container">
                              <div className="app-user__dropdown__inner">
                                <h3 className="app-user__title">
                                  <a href="/account/login" className="app-account__title__link">
                                    My Account
                                  </a>
                                </h3>
                                ...
                                <ul className="app-user__list">
                                  ...
                                  <li className="app-user__list__subscription">
                                  ...
                                  <li className="app-gray-clr">
                                    ...
                                    &nbsp;/&nbsp;
                                    <a href="/account/register" className="app-auth-link">
                                      Sign Up
                                    </a>
                                  </li>
                                </ul>
                ...
                <div className="app-nav__inner" id="app-nav__list-wrapper">
                  <ul className="app-nav__list">
                    <li className="app-nav__list__item app-subscribe-btn-holder" style={{ display: 'list-item' }}>
                      <a href="/pages/inner-circle" className="app-btn app-btn-purple app-subscribe-btn">
                        Subscribe
                      </a>
                    </li>
                      ...
                      <div className="app-nav__dr">
                        <div className="app-container">
                          <div className="app-row-d-2-1">
                              ...
                              <div className="app-row-d-3 app-nav__accordion">
                                <div className="app-col">
                                  <div className="app-nav__accordion__item">
                                    <strong className="app-nav__d__list-title app-nav__d__list-title__active">
                                      Shop by product
                                    </strong>
                                ...
                                <div className="app-col">
                                  <div className="app-nav__accordion__item">
                                    <strong className="app-nav__d__list-title">Shop by Fragrance</strong>
                                    <ul className="app-nav__d__list" id="app-list__fragrance">
                                      ...
                                      <li>
                                        <a href="/collections/all-products#fragrance=Fragrance:%20Floral%20Woods">
                                          Floral Woods
                                        </a>
                                      </li>
                                      <li>
                                      ...
                                      <li>
                                        <a href="/collections/all-products#fragrance=Fragrance:%20Spicy/%20Smoky">
                                          Spicy/ Smoky
                                        </a>
                                      </li>
                                      <li>
                                ...
                                <div className="app-col">
                                  <div className="app-nav__accordion__item">
                                    <strong className="app-nav__d__list-title">Shop by Material</strong>
                                    <ul className="app-nav__d__list" id="app-list__material">
                                      <li>
                                        <a href="/collections/all-products#material=Material:%2018K%20Gold%20Plated">
                                          18K Gold Plated
                                        </a>
                                      </li>
                                      <li>
                                      ...
                                      <li>
                                        <a href="/collections/all-products#material=Material:%20Rhodium%20plated">
                                          Rhodium plated
                                        </a>
                                      </li>
                                      <li>
                                  ...
                                  <div className="app-nav__accordion__item">
                                    ...
                                    <ul className="app-nav__d__list" id="app-list__color">
                                      ...
                                      <li>
                                        <a href="/collections/all-products#color=Metal%20Color:%20Rose%20Gold">
                                          Rose Gold
                                        </a>
                                      </li>
                                      <li>
                            ...
                            >
                              <img
                                src="https://fragrantjewels.s3.amazonaws.com/app/app-nav/nav-all-img-6-dt.jpg"
                                alt=""
                              />
                      ...
                      <div className="app-nav__dr">
                        <div className="app-container">
                          <div className="app-row-d-2a-1">
                              ...
                              <div className="app-row-d-2">
                                <a href="/pages/inner-circle" className="app-col app-add-product-col">
                                  <img
                                    ...
                                    alt=""
                                  />
                                  <strong className="app-nav__d__list-title">
                                    NEW INNER CIRCLE EXCLUSIVE COLLECTIONS EVERY MONTH
                                  </strong>
                                  <p>
                                    This month discover the beauty that lies beneath with the new Under the Sea
                                    collection.
                                  </p>
                                  <div>
                                    <strong className="app-add-product-col__link-text app-animated-link">
                                ...
                                <a href="/pages/rare-ic-page" className="app-col app-add-product-col">
                                  ...
                                  />
                                  <strong className="app-nav__d__list-title">
                                    EVERYTHING THERE IS TO KNOW ABOUT RARE COLLECTIONS
                                  </strong>
                                  <p>
                                    Start collecting unique limited edition sets not available for sale! Find out how
                                    you can qualify.
                                  </p>
                                  <div>
                                    <strong className="app-add-product-col__link-text app-animated-link">
                            ...
                            <div className="app-col">
                              <strong className="app-nav__d__list-title app-nav__d__list-title__main">
                                Subscription
                              </strong>
                              <ul className="app-nav__d__list">
                                <li>
                                  <a href="https://www.fragrantjewels.com/pages/inner-circle#how-it-works">
                                    How it Works
                                  </a>
                                </li>
                                <li>
                            ...
                            <div className="app-col">
                              <div className="app-row-d-2">
                                <a href="/pages/rewards-boutique" className="app-col app-add-product-col">
                                  <img
                                    src="https://fragrantjewels.s3.amazonaws.com/app/app-nav/nav-rewards-img-1.jpg"
                                    alt=""
                                  />
                                  <strong className="app-nav__d__list-title">NEW REWARDS EVERY WEEK</strong>
                                  <p>
                                    Every dollar you spend earns you reward points you can use to redeem free jewelry,
                                    products and more!
                                  </p>
                                  <div>
                                    <strong className="app-add-product-col__link-text app-animated-link">
                                ...
                                <a href="/pages/rewards-explainer" className="app-col app-add-product-col">
                                  <img
                                    src="https://fragrantjewels.s3.amazonaws.com/app/app-nav/nav-rewards-img-2.jpg"
                                    alt=""
                                  />
                  ...
                  <div id="app-nav__mobile-content" className="app-nav__mobile-content">
                    ...
                    <a href="/collections/spring" className="app-col app-add-product-col">
                      ...
                      <div>
                        <span className="app-animated-link app-nav__mobile-content__link">
                          <span>SHOP SPRING BLING</span>
                        </span>
                      </div>
                    </a>
                  </div>
                  <div className="app-account__wrapper" id="app-account__wrapper">
                    <h3 className="app-account__title">
                      <a href="/account/login" className="app-account__title__link">
                        Account
                      </a>
                    </h3>
                    <ul className="app-account__list">
                      ...
                      <li className="app-account__list__subscription">
                        <a href="/account/login">My Subscription</a>
                      </li>
                      <li>
                        <a href="/account/login">My Orders</a>
        ...
        <div className="app-re-content" id="app-content">
          <main className="app-h-main">
                  ...
                  <div className="pdp-col pdp-col-35">
                    <div className="pdp-product-info">
                              ...
                              <div className="pdp__chooser__item__part-bottom__inner">
                                <ul className="pdp__chooser__ic-list">
                                  ...
                                  <li>
                                    ...
                                    <span className="pdp__chooser__ic-list__text">
                                      Exclusive member pricing &amp; deals
                                    </span>
                                  </li>
                                  <li>
                                    <div className="pdp__chooser__ic-list__icon">
                      ...
                      <div className="pdp__additional-text">
                        ...
                        <a
                          href="/account/login?return_url=/products/lemon-drop-jewel-candle"
                          id="pdp__already-a-member-link"
                        >
                          Already a member?
                        </a>
                      </div>
                      ...
                      <div className="pdp-accordion" id="pdp-description">
                        ...
                        <div className="pdp-a-item">
                          ...
                          <div className="pdp-a-item__description">
                            <p className="p1">
                              <span className="s1">
                                Sweet, tart, and summery...&nbsp;our Lemon Drop candle will tickle your nose and
                                tantalize your taste buds with notes of{' '}
                        ...
                        <div className="pdp-a-item">
                          ...
                          <div className="pdp-a-item__description">
                            <div>
                              ...
                              <span>
                                &nbsp;you'll receive a code that gives you a chance to win a ring valued between $100
                                and $10,000!
                              </span>
                            </div>
                          </div>
            ...
            <section className="app-h-section app-h-products-section">
              <div className="app-h-container">
                <h2 className="app-h-section__title">
                  Recommended{' '}
                  <span>
                    <span className="app-h-section__title_part">for you</span>
                  </span>
                </h2>
                <div className="app-h-section__text"></div>
                <div className="app-h-product-cards">
                  <div className="app-h-product-slider" id="app-h-product-slider">
                    <div className="app-h-product-card app-h-product-card_new-product">
                      {/* <div class="app-h-product-card__inner"> */}
                      <div className="app-h-product-card__top">
                        {/* <button type="button" class="app-h-product-card__favorite">
                                        <svg width="25" height="22" viewBox="0 0 25 22" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M2.93138 2.77215C5.28911 0.409284 9.11174 0.409284 11.4695 2.77215L12.5815 3.88663L13.6936 2.77215C16.0513 0.409284 19.8739 0.409284 22.2317 2.77215C24.5894 5.13501 24.5894 8.96597 22.2317 11.3288L12.5815 21L2.93138 11.3288C0.573654 8.96597 0.573654 5.13501 2.93138 2.77215Z"
                                                fill="white" stroke="#9059C8" />
                                        </svg>
                                    </button> */}
                      ...
                      <div className="app-h-product-card__bottom">
                        <div className="app-h-product-card__rating app-h-stars">
                          ...
                          <a className="app-h-product-card__rating-link" href="#">
                            102
                          </a>
                        </div>
                        <div className="app-h-product-card__prices">
                          <span className="app-h-product-card__price app-h-product-card__price_compare">
                            <del>$39.95</del>
                          </span>
                    ...
                    <div className="app-h-product-card">
                      ...
                      <div className="app-h-product-card__top">
                        ...
                        <div className="app-h-product-card__tag">925 Sterling Silver</div>
                        <div className="app-h-product-card__members">Members Only</div>
                        <h4 className="app-h-product-card__title">
                          Moulin Rouge - Satin Collection - Bath Bomb and Candle Set
                        </h4>
                      </div>
                      <div className="app-h-product-card__bottom">
                        <div className="app-h-product-card__rating app-h-stars">
                  ...
                  <div className="app-h-progress-wrapper">
                    <div className="app-h-progress" role="progressbar" aria-valuemin={0} aria-valuemax={100}>
                      <span className="app-h-progress__label" id="app-h-progress__label" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* <section className="app-h-section app-h-products-section">
              <div className="app-h-container">
                <h2 className="app-h-section__title">More you might like</h2>
                <div className="app-h-section__text"></div>
                <div className="app-h-product-cards">
                  <div className="app-h-product-slider" id="app-h-product-slider">
                    <div className="app-h-product-card app-h-product-card_new-product">
        ...
        <footer className="app-pdp-footer">
          <div className="app-pdp-footer__inner">
            <div className="app-pdp-footer__row">
              <div className="app-pdp-footer__col app-pdp-footer__col-1">
                <div className="app-pdp-f-pr__row" onClick={() => setIsDropdownOpened(!isDropdownOpened)}>
                  <div className="app-pdp-f-pr__col app-pdp-f-pr__col-1">
                    <div className="app-pdp-f-pr__item">
                      <div className="app-pdp-f-pr__item__row">
                        <div className="app-pdp-f-pr__item__col app-pdp-f-pr__image-wrapper">
                          ...
                          >
                            <path
                              d="M1.14868 0.5L9.14868 8.5L17.1487 0.5"
                              stroke="black"
                              strokeWidth="0.5"
                              strokeMiterlimit={10}
                              strokeLinecap="round"
                        ...
                        <div className="app-pdp-f-pr__item__col app-pdp-f-pr__item__col-2">
                          <div className="app-pdp-f-pr-item__row-inner">
                            <div className="app-pdp-f-pr-item__col-inner">Bundle &amp; Save</div>
                            <div className="app-pdp-f-pr-item__col-inner">
                              <div className="app-pdp-f-pr__price">$32.95</div>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="app-pdp-f-pr__col app-pdp-f-pr__col-2 app-pdp-f-pr__size-wrapper">
                    <div className="app-pdp-f-pr__size">Size</div>
                ...
                {isDropdownOpened && (
                  <div className="app-pdp-f-dropdown app-pdp-f-dropdown_size-active app-pdp-f-dropdown_products-active">
                    <div className="app-pdp-f-pr__row">
                      <div className="app-pdp-f-pr__col app-pdp-f-pr__col-1 app-pdp-f-pr-dr">
                        <div className="app-pdp-f-pr__item">
                          <div className="app-pdp-f-pr__item__row">
                            <div className="app-pdp-f-pr__item__col app-pdp-f-pr__image-wrapper">
                              <img
                            ...
                            <div className="app-pdp-f-pr__item__col app-pdp-f-pr__item__col-2">
                              <div className="app-pdp-f-pr-item__row-inner">
                                <div className="app-pdp-f-pr-item__col-inner">Bath Bomb</div>
                                <div className="app-pdp-f-pr-item__col-inner">
                                  <div className="app-pdp-f-pr__price">$32.95</div>
                                </div>
                              </div>
                        ...
                        <div className="app-pdp-f-pr__item">
                          <div className="app-pdp-f-pr__item__row">
                            ...
                            <div className="app-pdp-f-pr__item__col app-pdp-f-pr__item__col-2">
                              <div className="app-pdp-f-pr-item__row-inner">
                                <div className="app-pdp-f-pr-item__col-inner">Candle</div>
                                <div className="app-pdp-f-pr-item__col-inner">
                                  <div className="app-pdp-f-pr__price">$32.95</div>
                                </div>
                              </div>
                      ...
                      <div className="app-pdp-f-pr__col app-pdp-f-pr__col-2 app-pdp-f-pr__size-wrapper">
                        <ul className="app-pdp-f-pr__size-list">
                          <li>
                            <a href="#">5</a>
                          </li>
                          <li>
            ...
            <div className="app-f-footer__inner">
              <ul className="app-f-social-list-mb app-f-social-list">
                ...
                <li>
                  <a href="#">
                    <svg width={19} height={19} viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M4.69599 6.76393H0.992689V18.7216H4.69599V6.76393Z" fill="white" />
                      <path
