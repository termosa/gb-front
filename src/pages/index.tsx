                        ...
                        <div className="app-row-d-2a-1">
                          <div className="app-col">
                            <div className="app-row-d-2">
                              ...
                              <a href="/pages/rare-ic-page" className="app-col app-add-product-col">
                                ...
                                <p>
                                  Start collecting unique limited edition sets not available for sale! Find out how you
                                  can qualify.
                                </p>
                                <div>
                                  <strong className="app-add-product-col__link-text app-animated-link">
                          ...
                          <div className="app-col">
                            ...
                            <ul className="app-nav__d__list">
                              ...
                              <li>
                                <a href="https://www.fragrantjewels.com/pages/inner-circle#current-box">Current Box</a>
                              </li>
                      ...
                      <svg width="127" height="40" viewBox="0 0 127 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                          <linearGradient
                            ...
                            gradientUnits="userSpaceOnUse"
                          >
                            <animate attributeName="x2" values="48;83.5;48" dur="7s" repeatCount="indefinite"></animate>
