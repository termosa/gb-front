            ...
            <div className="app-col">
              <div className="app-row">
                ...
                <div className="app-col app-re-header__icon-nav">
                  <button type="button" className="app-re-header__icon-nav__search" id="app-header__icon-nav__search">
                ...
                <div className="app-nav__dr">
                  <div className="app-container">
                    <div className="app-row-d-2-1">
                      ...
                      >
                        <img src="https://fragrantjewels.s3.amazonaws.com/app/app-nav/nav-all-img-6-dt.jpg" alt="" />
                ...
                <div className="app-nav__dr">
                  <div className="app-container">
                    <div className="app-row-d-2a-1">
                      <div className="app-col">
                        <div className="app-row-d-2">
                          ...
                          <a href="/pages/rare-ic-page" className="app-col app-add-product-col">
                            ...
                            <p>
                              Start collecting unique limited edition sets not available for sale! Find out how you can
                              qualify.
                            </p>
                            <div>
                              <strong className="app-add-product-col__link-text app-animated-link">
                      ...
                      <div className="app-col">
                        <strong className="app-nav__d__list-title app-nav__d__list-title__main">Subscription</strong>
                        <ul className="app-nav__d__list">
                          <li>
                            <a href="https://www.fragrantjewels.com/pages/inner-circle#how-it-works">How it Works</a>
                          </li>
